...
export const deleteDb = async (id) => {
    ...
    //  create a new transaction and specifiy the sote and data privileges.
    const tx = contactDb.transaction('contacts', 'readwrite');

    // opem ip the desired object store.
    const store = tx.objectStore('contacts');

    // use the .delete () method to get all data in the datbase.
